...
public class LevelGenerator : MonoBehaviour
{
    ...
    private void fixRotation(GameObject currentTile, int x, int y)
    {
        ...
        {
            case "outCorner":
                if (westObj != null && westObj.tag.Equals("outWall") &&
                    westObj.transform.rotation == Quaternion.identity)
                {
                    currentTile.transform.rotation = Quaternion.Euler(0, 0, -90);
                }

                if (northObj != null && eastObj != null && southObj != null && northObj.tag.Equals("outWall") &&
                    northObj.transform.rotation != Quaternion.identity && southObj.tag.Equals("outWall") &&
                    southObj.transform.rotation != Quaternion.identity && eastObj.tag.Equals("outCorner"))
                {
                    currentTile.transform.rotation = Quaternion.Euler(0, 0, 90);
                }

                if (westObj != null && southObj != null && southObj.tag.Equals("outCorner"))
                {
                    currentTile.transform.rotation = Quaternion.Euler(0, 0, -90);
                }

                if (northObj != null && westObj != null && westObj.tag.Equals("outWall"))
                {
                    currentTile.transform.rotation = Quaternion.Euler(0, 0, -180);
                }

                if (westObj != null && southObj != null && westObj.tag.Equals("outWall") && southObj.tag.Equals("outWall"))
                {
                    currentTile.transform.rotation = Quaternion.Euler(0, 0, -90);
                }
                break;
            case "outWall":
                if (eastObj != null && eastObj.tag.Equals("outCorner"))
                {
